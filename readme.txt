...
3. Build instructions
	...
	3.2 SCTP-AGENT
		...
		3.2.2  Set up real "tcps1", or use dummy.
			...
			If you are using VirtualBox, do the following to allow symbolic links :-
			  > ./VBoxManage.exe setextradata <VMNAME> VBoxInternal2/SharedFoldersEnableSymlinksCreate/<SHARENAME> 1
			  where 
				VMNAME is the name of the Virtual machine
				SHARENAME is the name of the shared folder minus the "sf_"
